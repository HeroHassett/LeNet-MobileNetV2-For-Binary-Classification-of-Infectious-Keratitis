...
import pickle
from ConvNet import LeNet_model
...
weights = LeNet_model.get_weights()
...
weights_file = open("/Users/alexk/Documents/GitHub/LeNet-MobileNetV2-For-Binary-Classification-of-Infectious-Keratitis/Parameters/weights.pkl", "rb")
...
def LeNet_forward_by_hand(image, weight_dict, pool_mode='max'):
    ...
    # Resize image to 256x256 pixels (Standard LeNet input size)
...
os.chdir("/Users/alexk/Documents/GitHub/LeNet-MobileNetV2-For-Binary-Classification-of-Infectious-Keratitis/Test_Images")
path = os.getcwd()
